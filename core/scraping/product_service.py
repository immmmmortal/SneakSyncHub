...
from core.scraping.api_scrapers import APIClient, AdidasProductScraper, \
    AdidasProductParser
from core.scraping.selenium_scrapers import WebDriver, NikeProductScraper, \
    NikeProductParser
...
class AdidasSetup:
    ...
    def initialize_parser(self) -> AdidasProductParser:
        return AdidasProductParser(
            self.product_info, self.product_sizes
        )
