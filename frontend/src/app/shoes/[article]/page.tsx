...
import DetailedViewLoadingComponent
    from "@/app/components/detailed_view_loading"; // Assuming you have an interface for the shoe
...
const ShoeDetailPage = ({params}: ShoeDetailPageProps) => {
    ...
    useEffect(() => {
        ...
        const fetchShoeByArticle = async () => {
            try {
                const response = await fetch(`https://localhost:8000/api/shoes/${article}`, {
                    method: 'GET',
    ...
    if (error || !shoe) {
        return <div
            className="w-full h-full flex items-center justify-center text-2xl">404
            -
            Shoe Not
            Found</div>;  // Display error or 404 if shoe is not found
    }
    ...
    return (
        <div className="">
            <div>
                <h1 className="text-3xl font-bold mb-4">Detailed
                    view</h1>
            </div>
            {loading ? <>
                ...
                <div className="flex flex-row p-5">
                    <div className="flex">
                        <Link href={shoe.url}
                              className="min-w-80 w-80 h-80 min-h-80">
                            <Image src={shoe.image} width="400" height="400"
                                   alt="{shoe.name}"
                    ...
                    <div className="ml-12 flex flex-col gap-5">
                        ...
                        <div className="mt-4 w-3/4">
                            ...
                            <Link
                                ...
                                href="https://www.nike.com/size-fit/unisex-footwear-mens-based">
                            ...
                            <div
                                className="mt-2 text-lg p-2 rounded-2xl text-gray-500 flex flex-row flex-wrap flex-1 gap-1 w-3/4 overflow-clip min-w-fit"
                            >
                        ...
                        <div>
                            ...
                            <div className="mt-10">
                                <p className="text-lg font-bold">Free
                                    Pickup</p>
                ...
                <div className="mt-8">
                    <h2 className="text-2xl font-bold mb-8">Price
                        History</h2>
